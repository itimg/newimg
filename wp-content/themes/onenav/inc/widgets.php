...
class about extends WP_Widget {
    ...
    function form($instance) {
        ...
        $instance = wp_parse_args((array) $instance, array('about_back' => '//iowen.gitee.io/ioimg/banner/wHoOcfQGhqvlUkd.jpg'));
...
class about_author extends WP_Widget {
    ...
    function form($instance) { 
        global $wpdb;
        $instance = wp_parse_args((array) $instance, array('author_back' => '//iowen.gitee.io/ioimg/banner/wHoOcfQGhqvlUkd.jpg'));
