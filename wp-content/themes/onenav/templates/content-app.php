            ...
            <div class="row app-content py-5 mb-xl-5 mb-0 mx-xxl-n5">
                ...
                <div class="col">
                    <div class="d-md-flex mt-n3 mb-5 my-xl-0">
                        ...
                        <div class="app-info">
                            <h1 class="h3 text-center text-md-left mb-0"><?php echo $app_name ?>
                            ...
                            <p class="text-muted mb-4">
                                <span class="info-term mr-3"><?php _e('更新日期：','i_theme') ?><?php echo io_date_time($down_list[0]['app_date'],false) ?></span>
                            ...
                            <div class="mb-2 app-button"> 
                                ...
                                <?php like_button(get_the_ID(),'app') ?>
                            </div> 
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">  
                        <div class="modal-body down_body"> 
                            <h3 class="h6"><?php _e('下载地址: ','i_theme') ?><?php echo $app_name ?> - <span class="app-v">1.00</span></h3>
                            <div class="row mt-4">
                                <div class="col-6 col-md-7"><?php _e('描叙','i_theme') ?></div>
...
<script type="text/javascript">
    ...
    $(document).on('click','button.btn_down',function(ev) {
        ...
        for(var i=0;i<down.down_url.length;i++){
            var url = down.down_url[i].down_btn_url==""?"javascript:":home+'/go/?url='+encodeURIComponent(down.down_url[i].down_btn_url);/*is_go?home+'/go/?url='+down.down_url[i].down_btn_url:down.down_url[i].down_btn_url;*/
            var target = down.down_url[i].down_btn_url==""?'':' target="_blank"';
            var html = '<div class="row">';
            html += '<div class="col-6 col-md-7">'+(down.down_url[i].down_btn_info?down.down_url[i].down_btn_info:'<?php _e('无','i_theme') ?>') + '</div>';
            html += '<div class="col-2 col-md-2" style="white-space: nowrap;">'+ (down.down_url[i].down_btn_tqm?down.down_url[i].down_btn_tqm:'<?php _e('无','i_theme') ?>')+'</div>';
            html += '<div class="col-4 col-md-3 text-right"><a class="btn btn-danger custom_btn-d py-0 px-1 mx-auto down_count copy-data text-sm" href="'+url+'" '+target+' data-clipboard-text="'+ down.down_url[i].down_btn_tqm+'" data-id="<?php echo get_the_ID() ?>" data-action="down_count" data-mmid="down-mm-'+i+'">'+down.down_url[i].down_btn_name+'</a></div>';
            html += '</div>';
