                ...
                <div class="col-8">
                    <div class="card-body list-content p-2 p-xl-3" style="height: 100%;"> 
                        <div class="list-body"> 
            				...
            				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="list-title no-c text-md overflowClip_1" <?php echo new_window() ?>><?php show_sticky_tag( is_sticky() ) . show_new_tag(get_the_time('Y-m-d H:i:s')) ?><?php the_title(); ?></a>
