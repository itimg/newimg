        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">  
                <div class="modal-body">
                    <div class="modal-title text-center text-lg mb-4"><?php _e('添加自定义网址', 'i_theme' ); ?><?php if(io_get_option('user_center')): ?><br><span class="text-sm text-muted"><?php _e('登录后可以保存到账号！', 'i_theme' ); ?></span><?php endif; ?></div>
