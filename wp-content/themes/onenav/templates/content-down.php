                    ...
                    <div class="d-md-flex mt-n3 mb-5 my-xl-0">
                        ...
                        <div class="app-info">
                            ...
                            <p class="mb-0 text-muted text-sm"> 
                                ...
                                if(!wp_is_mobile()){
                                $width = 150;
                                $qrurl = "<img src='".str_ireplace(array('$size','$url'),array($width,get_permalink(get_the_ID())),io_get_option('qr_url'))."' width='{$width}'>"; 
                                ?>
                            ...
                            <div class="down_btn_list my-4">
								...
								<?php  
									for($i=0;$i<count($down_list);$i++){
                                        ...
                                        echo '<div class="col-4 col-md-3 text-right"><a class="btn btn-danger custom_btn-d py-0 px-1 mx-auto down_count text-sm" href="'. home_url().'/go/?url='.base64_encode($down_list[$i]['down_btn_url']) .'" target="_blank" data-id="'. get_the_ID() .'" data-action="down_count" data-clipboard-text="'.($down_list[$i]['down_btn_tqm']?:'').'" data-mmid="down-mm-'.$i.'">'.$down_list[$i]['down_btn_name'].'</a></div>';
