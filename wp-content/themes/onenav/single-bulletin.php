    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="post-cover overlay-hover mb-3 mb-md-4">
                <div class="media rounded media-5x1">
                    <?php if(io_get_option('lazyload')): ?>
                        <div class="media-content" data-src="//iowen.gitee.io/ioimg/banner/C1ayMpdRkPGvtI7.jpg"><span class="overlay"></span></div>
                    <?php else: ?>
                        <div class="media-content"style="background-image: url(//iowen.gitee.io/ioimg/banner/C1ayMpdRkPGvtI7.jpg);"><span class="overlay"></span></div>
                    <?php endif ?>
            ...
            <div class="card-body">
                ...
                <span class="mr-3"><a class="btn-like btn-link-like <?php echo $liked ?>" href="javascript:;" data-action="post_like" data-id="<?php echo get_the_ID() ?>"><i class="iconfont icon-like"></i> <span class="like-count"><?php echo $like_count ?></span></a></span>
