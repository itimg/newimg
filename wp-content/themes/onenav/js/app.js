...
(function($){ 
    ...
    function stickFooter() {
        ...
        if(main_footer.hasClass('text-xs'))
        {
    ...
    $(document).on('mouseenter','.mini-sidebar .sidebar-menu ul:first>li,.mini-sidebar .flex-bottom ul:first>li',function(){
        ...
        sidebar_second.length == 0 && ($("body").append("<div class='second sidebar-popup sidebar-menu-inner text-sm'><div></div></div>"));
        ...
        _this.one('mouseleave', function() {
            if($('.sidebar-nav').hasClass('mini-sidebar') && $('.sidebar-scroll').innerHeight() > $('.sidebar-menu').innerHeight()){
                $('.mini-sidebar .sidebar-menu').one('mouseleave', function() {sidebar_second.hide();})
            }else{
                sidebar_second.hide();
            }
        });
    });
    $(document).on('mouseenter','.mini-sidebar .slimScrollBar,.second.sidebar-popup',function(){
        var sidebar_second = $(".sidebar-popup.second");
        sidebar_second.show();
